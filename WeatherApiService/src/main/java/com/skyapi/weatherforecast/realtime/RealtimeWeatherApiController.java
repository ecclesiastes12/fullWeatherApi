...
//	}
	...
	public ResponseEntity<?> getRealtimeWeatherByIPAddress(HttpServletRequest request){
		...
		//catch block commented out because LocationNotFoundException is handled in GlobalExceptionHandler.java
		//check RealtimeWeatherApiController2.java for previous code
		/*catch (LocationNotFoundException e) {
			LOGGER.error(e.getMessage(), e);
			return ResponseEntity.notFound().build();
		}*/
	...
	public ResponseEntity<?> getRealtimeWeatherByLocationCode(@PathVariable("locationCode") String locationCode) {
		//try catch block deleted because LocationNotFoundException is handled in GlobalExceptionHandler.java
		//check RealtimeWeatherApiController2.java for previous code
...
//	}
	...
	/*
	 * code modified see updateRealtimeWeather to see code changes in this method
	 * 
	 * METHOD UPDATED TO READ THE REQUEST BODY AS A DTO
	 * */
	...
	public ResponseEntity<?>  updateRealtimeWeather(@PathVariable("locationCode") String locationCode,
		...
		//convert the data from dto object to entity class or object
	...
	//method that convert RealtimeWeatherDTO object to a entity object
